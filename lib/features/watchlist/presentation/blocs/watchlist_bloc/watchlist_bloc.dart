...
import '../../../domain/usecases/check_if_watchlist_item_added_usecase.dart';
...
class WatchlistBloc extends Bloc<WatchlistEvent, WatchlistState> {
  WatchlistBloc(
    ...
    on<CheckWatchListAddedEvent>(_checkWatchListAdded);
  }
  ...
  final CheckIfWatchlistItemAddedUseCase _checkIfItemAddedUseCase;
  ...
  FutureOr<void> _checkWatchListAdded(
    CheckWatchListAddedEvent event,
